"""Analyzer: JSON parsing, normalization, and the deterministic rules."""
...
def test_parse_reads_the_expected_shape():
    text = (
        '{"language":"en","score":30,"summary":"weak",'
        '"issues":[{"category":"format","severity":"high","title":"No format","detail":"add one","evidence":"write"}]}'
    )
...
def test_heuristic_accepts_a_specific_prompt(translator):
    prompt = (
        "Summarize the attached report as a bullet list of at most 200 words for a client.\n"
